...
- Phase K: seeded-field inverse search — the deterministic gray-noise
  ...
  is evidence-ordered: AVX-512 first, then scalar, then AVX2).  Negative
  controls are independently generated SHA-256 random bytes with no exact
  match in the evaluated detector/seed-sweep universes, and they fall
  back honestly.

...
exact per-phase status. In short: the exact U1 model, canonical IR,
hostile-input-safe parser, scalar materializer and residual closure are
implemented and tested; AVX2/AVX-512/Rayon/CUDA acceleration, the inverse
compiler, and the corpus/courts land in the numbered phases.
